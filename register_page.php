<?php
require_once $_SERVER['DOCUMENT_ROOT'].'/feb_pd/resources/php/class/register_script.php';
                ...
                <div class="card-body">
                    <form action="register.php" method="post" >
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control " name="username" value="" required autocomplete= />
                            </div>
                        </div>
                        <div class="form-group row">
